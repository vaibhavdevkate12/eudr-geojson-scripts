    ...
    // Polygon validation
      ...
      if (!Array.isArray(coords)) {
        ...
        if (!Array.isArray(outerRing)) {
          ...
          // Validate coordinates in the outer ring
          ...
          if (positionsValid) {
            ...
            // Duplicate consecutive coordinates after 6-decimal rounding are automatically cleaned in the optimization phase.
          }
        }
        ...
        try {
          ...
          console.warn(`Turf kinks check failed for feature ${i}: ${kinksErr.message}`);
        }
      }
    }
    ...
    // MultiPolygon validation
      ...
      if (!Array.isArray(coords)) {
        ...
        try {
          ...
          console.warn(`Turf kinks check failed for MultiPolygon feature ${i}: ${kinksErr.message}`);
        }
      }
    }
  }
